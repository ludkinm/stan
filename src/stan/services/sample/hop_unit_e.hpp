#ifndef STAN_SERVICES_SAMPLE_HOP_UNIT_E_HPP
#define STAN_SERVICES_SAMPLE_HOP_UNIT_E_HPP
...
/**
 * Runs static Hop with unit Euclidean
...
int hop_unit_e(Model& model, const stan::io::var_context& init,
  ...
  logger.info("services::hop_unit_e");
