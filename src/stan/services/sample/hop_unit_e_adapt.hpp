#ifndef STAN_SERVICES_SAMPLE_HOP_UNIT_E_ADAPT_HPP
#define STAN_SERVICES_SAMPLE_HOP_UNIT_E_ADAPT_HPP
...
#include <stan/mcmc/hop/adapt_unit_e_hop.hpp>
...
/**
 * Runs HOP with unit Euclidean metric with adaptation.
 *
