#ifndef STAN_SERVICES_SAMPLE_HUG_UNIT_E_HPP
#define STAN_SERVICES_SAMPLE_HUG_UNIT_E_HPP
...
/**
 * Runs static Hug with unit Euclidean
...
int hug_unit_e(Model& model, const stan::io::var_context& init,
  ...
  logger.info("services::hug_unit_e");
  ...
  stan::mcmc::unit_e_hug<Model, boost::ecuyer1988> sampler(model, rng);
