#ifndef STAN_SERVICES_SAMPLE_HUG_DIAG_E_HPP
#define STAN_SERVICES_SAMPLE_HUG_DIAG_E_HPP
...
int hug_diag_e(Model& model, const stan::io::var_context& init,
               ...
               double int_time, callbacks::interrupt& interrupt,
  ...
  stan::mcmc::diag_e_hug<Model, boost::ecuyer1988> sampler(model, rng);
...
int hug_diag_e(Model& model, const stan::io::var_context& init,
  ...
  return hug_diag_e(model, init, unit_e_metric, random_seed, chain, init_radius,
                    num_warmup, num_samples, num_thin, save_warmup, refresh,
                    stepsize, stepsize_jitter, int_time, interrupt, logger,
