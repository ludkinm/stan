#ifndef STAN_SERVICES_SAMPLE_HUG_DENSE_E_HPP
#define STAN_SERVICES_SAMPLE_HUG_DENSE_E_HPP
...
int hug_dense_e(Model& model, const stan::io::var_context& init,
                ...
                double stepsize_jitter, double int_time,
  ...
  stan::mcmc::dense_e_hug<Model, boost::ecuyer1988> sampler(model, rng);
...
int hug_dense_e(Model& model, const stan::io::var_context& init,
  ...
  return hug_dense_e(model, init, unit_e_metric, random_seed, chain,
                     init_radius, num_warmup, num_samples, num_thin,
                     save_warmup, refresh, stepsize, stepsize_jitter, int_time,
