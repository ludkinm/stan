#ifndef STAN_SERVICES_SAMPLE_HOP_DENSE_E_HPP
#define STAN_SERVICES_SAMPLE_HOP_DENSE_E_HPP
...
namespace sample {
/**
 * Runs Hop without adaptation using dense Euclidean metric
...
int hop_dense_e(Model& model, const stan::io::var_context& init,
  ...
  stan::mcmc::dense_e_hop<Model, boost::ecuyer1988> sampler(model, rng);
...
int hop_dense_e(Model& model, const stan::io::var_context& init,
  ...
  return hop_dense_e(model, init, unit_e_metric, random_seed, chain,
                     init_radius, num_warmup, num_samples, num_thin,
                     save_warmup, refresh, lambda, kappa,
